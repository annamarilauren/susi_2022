...
def para(period='start-end'):
    sites ={
        ...
        'ansa21':{'ntubes':6, 'file': 'DWTansa21Interp.csv', 'wfile': 'muhos_weather.csv',
                  ...
                  'vonP':[6,6,5,4,6,6], 'ptype':['A','A','A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
        ...
        'neva11':{'ntubes':6, 'file': 'DWTneva11Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'mottifile':'neva11_A.xls','ddepth': -1.03, 'Swidth': 25.,
        ...
        'neva14':{'ntubes':6, 'file': 'DWTneva14Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'mottifile':'neva14_A.xls', 'ddepth': -1.03, 'Swidth': 25.,
                  'vonP':[5,5,5,4,4,4], 'ptype':['A','A','A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
        ...
        'neva31':{'ntubes':10, 'file': 'DWTneva31Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'mottifile':'neva31_A.xls', 'ddepth': -1.08, 'Swidth': 25.,
        ...
        'neva34':{'ntubes':10, 'file': 'DWTneva34Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'mottifile':'neva34_A.xls','ddepth': -1.08, 'Swidth': 25.,
                  'vonP':[5,5,4,5,5,5], 'ptype':['A','A','A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
        ...
        'start-thin':{
        'ansa11':{'ntubes':6, 'file': 'DWTansa11Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[4,6,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'wet', 'bulk dens':122.6, 'thinning': True,
                  'vol':[94.5,105.33], 'sfc':3},
        'ansa16':{'ntubes':3, 'file': 'DWTansa16Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[4,6,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'dry', 'bulk dens':122.6, 'thinning': True,
                  'vol':[143.2,149.7], 'sfc':3},
        'ansa21':{'ntubes':6, 'file': 'DWTansa21Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[6,6,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'wet', 'bulk dens':128.7, 'thinning': False,
                  'vol':[140.0, 156.6], 'sfc':3},
        'ansa26':{'ntubes':3, 'file': 'DWTansa26Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[6,6,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'dry', 'bulk dens':128.7, 'thinning': False,
                  'vol':[109.9, 118.9], 'sfc':3},
        'jaakkoin61':{'ntubes':6, 'file': 'DWTjaakkoin61Interp.csv', 'wfile': 'jaakkoinsuo_weather.csv',
                  'vonP':[4,8,7,7], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,3), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'wet','bulk dens':134., 'thinning': False,
                  'vol':[144.3, 155.2], 'sfc':5},
        'jaakkoin62':{'ntubes':8, 'file': 'DWTjaakkoin62Interp.csv', 'wfile': 'jaakkoinsuo_weather.csv',
                  'vonP':[4,8,7,7], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,3), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'dry','bulk dens':134., 'thinning': False,
                  'vol':[149.3, 165.6], 'sfc':5},
        'koira11':{'ntubes':3, 'file': 'DWTkoira11Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'wet','bulk dens':108.6, 'thinning': False,
                  'vol':[90.9, 98.17], 'sfc':2},
        'koira12':{'ntubes':3, 'file': 'DWTkoira12Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'dry','bulk dens':108.6, 'thinning': False,
                  'vol':[122.9, 137.6], 'sfc':2},
        'koira21':{'ntubes':3, 'file': 'DWTkoira21Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'wet','bulk dens':108.6, 'thinning': True,
                  'vol':[97.4, 105.92], 'sfc':2},
        'koira22':{'ntubes':3, 'file': 'DWTkoira22Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2008,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'dry','bulk dens':108.6, 'thinning': True,
                  'vol':[92.2, 106.24], 'sfc':2},
        'neva11':{'ntubes':6, 'file': 'DWTneva11Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2008,12,31), 'status': 'dry','bulk dens':113.25, 'thinning': False,
                  'vol':[163.4, 178.69], 'sfc':3},
        'neva14':{'ntubes':6, 'file': 'DWTneva14Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,7), 
                  'end_date':datetime.datetime(2008,12,31), 'status': 'wet','bulk dens':113.25, 'thinning': False,
                  'vol':[142.9, 158.3], 'sfc':3},
        'neva21':{'ntubes':7, 'file': 'DWTneva21Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[4,4,4,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2008,12,31), 'status': 'dry','bulk dens':97.8, 'thinning': True,
                  'vol':[100.32, 104.5], 'sfc':3},
        'neva24':{'ntubes':6, 'file': 'DWTneva24Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[4,4,4,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2008,12,31), 'status': 'wet','bulk dens':97.8, 'thinning': True,
                  'vol':[143.6, 147.3], 'sfc':3},
        'neva31':{'ntubes':10, 'file': 'DWTneva31Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,4,5], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2008,12,31), 'status': 'dry','bulk dens':122.5, 'thinning': False,
                  'vol':[127.2, 137.6], 'sfc':3},
        'neva34':{'ntubes':10, 'file': 'DWTneva34Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,4,5], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2008,12,31), 'status': 'wet','bulk dens':122.5, 'thinning': False,
                  'vol':[100.4, 111.5], 'sfc':3},
        'parkano11':{'ntubes':12, 'file': 'DWTparkano11Interp.csv', 'wfile': 'parkano_weather.csv',
                  'vonP':[3,5,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'dry','bulk dens':99.35, 'thinning': False,
                  'vol':[167.7, 180.], 'sfc':5},
        'parkano12':{'ntubes':14, 'file': 'DWTparkano12Interp.csv', 'wfile': 'parkano_weather.csv',
                  'vonP':[3,5,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2011,12,31), 'status': 'wet','bulk dens':99.35, 'thinning': True,
                  'vol':[263.,268.], 'sfc':5},
        'katila':{'ntubes':35, 'file': 'DWTkatilaInterp.csv', 'wfile': 'katila_weather.csv',
                  'vonP':[5,7,9,7], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2007,1,1), 
                  'end_date':datetime.datetime(2009,12,31), 'status': 'wetdry','bulk dens':136.4, 'thinning': False,
                  'vol':[153., 159.], 'sfc':5},
        },
        
        'thin-end':{
        'ansa11':{'ntubes':6, 'file': 'DWTansa11Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[4,6,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,8), 'status': 'wet', 'bulk dens':122.6, 'thinning': True,
                  'vol':[98.13,121.31], 'sfc':3},
        'ansa16':{'ntubes':3, 'file': 'DWTansa16Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[4,6,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,8), 'status': 'dry', 'bulk dens':122.6, 'thinning': True,
                  'vol':[101.4, 135.3], 'sfc':3},
        'ansa21':{'ntubes':6, 'file': 'DWTansa21Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[6,6,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,8), 'status': 'wet', 'bulk dens':128.7, 'thinning': False,
                  'vol':[156.6,187.07], 'sfc':3},
        'ansa26':{'ntubes':3, 'file': 'DWTansa26Interp.csv', 'wfile': 'muhos_weather.csv',
                  'vonP':[6,6,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,8), 'status': 'dry', 'bulk dens':128.7, 'thinning': False,
                  'vol':[118.9,140.86], 'sfc':3},
        'jaakkoin61':{'ntubes':6, 'file': 'DWTjaakkoin61Interp.csv', 'wfile': 'jaakkoinsuo_weather.csv',
                  'vonP':[4,8,7,7], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2013,10,30), 'status': 'wet','bulk dens':134., 'thinning': False,
                  'vol':[155.2,172.6], 'sfc':5},
        'jaakkoin62':{'ntubes':8, 'file': 'DWTjaakkoin62Interp.csv', 'wfile': 'jaakkoinsuo_weather.csv',
                  'vonP':[4,8,7,7], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2013,10,30), 'status': 'dry','bulk dens':134., 'thinning': False,
                  'vol':[165.6,186.6], 'sfc':5},
        'koira11':{'ntubes':3, 'file': 'DWTkoira11Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,17), 'status': 'wet','bulk dens':108.6, 'thinning': False,
                  'vol':[98.17,113.7], 'sfc':2},
        'koira12':{'ntubes':3, 'file': 'DWTkoira12Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,17), 'status': 'dry','bulk dens':108.6, 'thinning': False,
                  'vol':[137.6,166.9], 'sfc':2},
        'koira21':{'ntubes':3, 'file': 'DWTkoira21Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,17), 'status': 'wet','bulk dens':108.6, 'thinning': True,
                  'vol':[75.37,91.3], 'sfc':2},
        'koira22':{'ntubes':3, 'file': 'DWTkoira22Interp.csv', 'wfile': 'koirasuo_weather.csv',
                  'vonP':[4,4,5,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2014,10,17), 'status': 'dry','bulk dens':108.6, 'thinning': True,
                  'vol':[72.32,87.13], 'sfc':2},
        'neva11':{'ntubes':6, 'file': 'DWTneva11Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2009,1,1), 
                  'end_date':datetime.datetime(2014,12,31), 'status': 'dry','bulk dens':113.25, 'thinning': False,
                  'vol':[178.69, 227.5], 'sfc':3},
        'neva14':{'ntubes':6, 'file': 'DWTneva14Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,5,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2009,1,1), 
                  'end_date':datetime.datetime(2014,12,31), 'status': 'wet','bulk dens':113.25, 'thinning': False,
                  'vol':[158.3,191.4], 'sfc':3},
        'neva21':{'ntubes':7, 'file': 'DWTneva21Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[4,4,4,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2009,1,1), 
                  'end_date':datetime.datetime(2014,12,31), 'status': 'dry','bulk dens':97.8, 'thinning': True,
                  'vol':[82.3,109.89], 'sfc':3},
        'neva24':{'ntubes':6, 'file': 'DWTneva24Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[4,4,4,4], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2009,1,1), 
                  'end_date':datetime.datetime(2014,12,31), 'status': 'wet','bulk dens':97.8, 'thinning': True,
                  'vol':[93.6,124.7], 'sfc':3},
        'neva31':{'ntubes':10, 'file': 'DWTneva31Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,4,5], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2009,1,1), 
                  'end_date':datetime.datetime(2014,12,31), 'status': 'dry','bulk dens':122.5, 'thinning': False,
                  'vol':[137.6,161.5], 'sfc':3},
        'neva34':{'ntubes':10, 'file': 'DWTneva34Interp.csv', 'wfile': 'nevajarvi_weather.csv',
                  'vonP':[5,5,4,5], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2009,1,1), 
                  'end_date':datetime.datetime(2014,12,31), 'status': 'wet','bulk dens':122.5, 'thinning': False,
                  'vol':[111.5,147.3], 'sfc':3},
        'parkano11':{'ntubes':12, 'file': 'DWTparkano11Interp.csv', 'wfile': 'parkano_weather.csv',
                  'vonP':[3,5,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2011,11,11), 'status': 'dry','bulk dens':99.35, 'thinning': False,
                  'vol':[180.,192.4], 'sfc':5},        
        'parkano12':{'ntubes':14, 'file': 'DWTparkano12Interp.csv', 'wfile': 'parkano_weather.csv',
                  'vonP':[3,5,6,6], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2011,11,11), 'status': 'wet','bulk dens':99.35, 'thinning': True,
                  'vol':[155.,173.5], 'sfc':5},        
        'katila':{'ntubes':35, 'file': 'DWTkatilaInterp.csv', 'wfile': 'katila_weather.csv',
                  'vonP':[5,7,9,7], 'ptype':['A','A','A','A'], 'start_date':datetime.datetime(2010,1,1), 
                  'end_date':datetime.datetime(2011,12,11), 'status': 'wetdry','bulk dens':136.4, 'thinning': False,
                  'vol':[159.,164.], 'sfc':5}
        }
        }
